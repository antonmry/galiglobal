...
CI: `.github/workflows/deploy.yml` runs both steps on every push (and can be dispatched manually). It commits and pushes changes when formatting alters files.
