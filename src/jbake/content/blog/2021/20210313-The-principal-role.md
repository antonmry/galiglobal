...
is for seniors who jump between teams. In others, it's for engineers more
focused in processes than in systems. Anyway, in my opinion a Principal Software
...
What a revelation! As explained in the article, I've being a Principal Software
...
reasons, being the typical than **it's easier to ask you about something than
...
One of the best ways to avoid this is apply **the leader-leader approach** as
explained in the book [Turn the ship around]. Don't tell people what they have
to do but help them to define next steps and identify trade-offs. I always try
to make questions instead of give answers: "Have you tried ...?", "What do you
think of... ?", "What do you propose as alternative?", etc. [Senior Engineers
build consensus].

You will have a better life, and which it's more important, you will focus in
what's really important. Your teams will grow and learn and they will be happy
because of that. **Being a hero, you become the villain. Don't do that.**
...
Finally, if you encounter toxic people, **don't let them make you loose your
optimism.** In most cases, report it to my manager and ignore them after that
worked well for me. As we said in Spain, time puts everyone in their place.

## Don't stop coding

Coding is the best expression of the work of a Software Engineer. **It's how we
transform ideas in something real**. It's also a very demanding task. If you
stop coding for a while, you loose a lot of fluency and it becomes very
frustrating.  If you add the lack of your enough long calendar slots and all
...
- Try to **block in your calendar some time everyday for coding**: I usually
...
- **Avoid to work in things which are in the critical path**: you aren't going
...
- **Daily goal: code everyday**. I track my daily tasks and I have one for
...
in the end of the Individual Contributor path. Indeed, your contributions come
...
a total different role and you should be aware of that. **It has little value
a promotion if it isn't what makes your life happier**.
...
already one: [Staff Engineer: Leadership beyond the management track].

I would love to know what do you thing about the Principal role, specially if
