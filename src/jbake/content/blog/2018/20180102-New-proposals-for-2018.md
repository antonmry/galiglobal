...
Instead of that, I will try to update more frequently the blog with technical content. I've reading a lot about JVM performance in the last months, I have some experience and it's a interesting subject for the blog. I will also try to attend a couple of international events related to the JVM. And, only if I have time, some open source contributions in that field.
