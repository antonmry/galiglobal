...
**Am I a manager? No.** In some cases, people may report to me from an organisational point of view but my way to manage is "don't manage at all" and let the team self organize with my help. I tend to focus more on the team and processes and less on people. I'm not a manager, I try to be a technical leader. Organizations that understand the [Trident Career Model](https://www.thekua.com/atwork/2019/02/the-trident-model-of-career-development/) have *"a great advantage because at scale, it is often hard to find people who have deep skills and experiences at both of these areas, and that it can be useful to discuss where someone's focus, passion or development progression lies"*. I think I could be a manager, but it wouldn't be so fun and, definitively, I don't want to be both things at the same time.
...
This article made it to the top 5 articles in HackerNews! There are [a lot of interesting comments](https://news.ycombinator.com/item?id=27231521) covering very different points of view.
