...
One of my favourite Kafka KIPs is
...
health of your clients and the impact they have on the Kafka cluster.
...
You can download the latest version of Kafka from the
[Apache Kafka website](https://kafka.apache.org/downloads). It's very easy to
set up a Kafka cluster with Kraft following the official documentation, in
particular the [Quickstart](https://kafka.apache.org/quickstart) guide.
...
Yammer metrics custom reporters.
...
interested in the cluster metrics for this article.
...
In this particular example, we are going to send the metrics to an OpenTelemetry
